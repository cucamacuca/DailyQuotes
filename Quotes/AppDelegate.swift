...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication,
        ...
        reply: (([NSObject : AnyObject]!) -> Void)!) {
            ...
            // get the corresponding object to a specific action
            var action = Action().getAction(userInfo)
            
            // execute the action and reply (Strategy pattern)
            action.execute { (object) -> Void in
